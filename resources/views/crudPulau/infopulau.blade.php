            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Info Pulau</h3>
                        <p class="animated fadeInDown">
                          Form <span class="fa-angle-right fa"></span> Info Pulau
                        </p>
                    </div>
                  </div>
                </div>
                         ...
                         <div class="panel-body" style="padding-bottom:30px;">
                          <div class="col-md-12">
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Nama Pulau</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{ $pulau->nama_pulau }}" name="nama_pulau" readonly></div>
                            </div>
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Status</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{ $pulau->status }}" name="luas" readonly></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label text-right">Luas</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{ $pulau->luas }}" name="luas" readonly></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label text-right">Negara</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{ $pulau->nama_negara }}" name="nama_negara" readonly></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label text-right">Lokasi</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{ $pulau->lokasi }}" name="lokasi" readonly></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label text-right">Harga</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{ $pulau->harga }}" name="harga" readonly></div>
                            </div>
                            
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Deskripsi</label>
                              <div class="col-sm-10"><textarea class="form-control" rows="5" name="deskripsi" readonly>{{ $pulau->deskripsi }}</textarea></div>
                            </div><br><br><br><br><br>
                            
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Dibuat</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{ $pulau->created_at }}" readonly></div>
                            </div>
                            
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Diubah</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{ $pulau->updated_at }}" readonly></div>
                            </div>
