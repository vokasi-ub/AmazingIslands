                         ...
                         <div class="panel-body" style="padding-bottom:30px;">
                          <div class="col-md-12">
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Nama Pulau</label>
                              <div class="col-sm-10"><input type="text" class="form-control" name="nama_pulau"></div>
                            </div>
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Luas</label>
                              <div class="col-sm-10"><input type="text" class="form-control" name="luas"></div>
                            </div>
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Negara</label>
                              <div class="col-sm-10"><input type="text" class="form-control" name="nama_negara"></div>
                            </div>
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Harga</label>
                              <div class="col-sm-10"><input type="text" class="form-control" name="harga"></div>
                            </div>
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Deskripsi</label>
                            <div class="col-sm-10"><textarea class="form-control" rows="5" name="deskripsi"></textarea></div>
                            </div>
                            <div class="col-md-2" style="margin-top:25px; margin-left:120px;">
                                <button class="btn ripple btn-round btn-primary">
                                    <div>
                                      <span>Submit</span>
                                    </div>
                                </button>
