<div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        ...
                        <p class="animated fadeInDown"><span class="fa  fa-map-marker"></span> Malang,Indonesia</p>
              ...
              <div class="col-md-08 padding-0">
                 <div class="panel bg-light-blue">
                    <div class="panel-body text-white">
                      <center><div class="col-md-12 icon-box">
                        <h3><span class="icons icon-user"> Selamat Datang Admin</span></h3></center>
