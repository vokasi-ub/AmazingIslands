            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Info Inqiure</h3>
                        <p class="animated fadeInDown">
                          Form <span class="fa-angle-right fa"></span> Info Inquire
                        </p>
                    </div>
                  </div>
                </div>
                         ...
                         <div class="panel-body" style="padding-bottom:30px;">
                          <div class="col-md-12">
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Nama</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{$inquire->user['name']}}" name="nama_pulau" readonly></div>
                            </div>
                            
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Email</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{$inquire->user['email']}}" name="luas" readonly></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label text-right">No HP</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{$inquire->user['no_hp']}}" name="luas" readonly></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label text-right">Nama Pulau</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{$inquire->pulau['nama_pulau']}}" name="nama_negara" readonly></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label text-right">Total Orang</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{$inquire->total_orang}}" name="lokasi" readonly></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label text-right">Tanggal Sewa</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{$inquire->tanggal}}" name="harga" readonly></div>
                            </div>
                            
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Pesan</label>
                              <div class="col-sm-10"><textarea class="form-control" rows="5" name="deskripsi" readonly>{{$inquire->pesan}}</textarea></div>
                            </div><br><br><br><br><br>
                            
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Dibuat</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{ $inquire->created_at }}" readonly></div>
                            </div>
                            
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Diubah</label>
                              <div class="col-sm-10"><input type="text" class="form-control" value="{{ $inquire->updated_at }}" readonly></div>
                            </div>
