        ...
        <div class="col-md-8">
          <div class="aa-properties-content">            
            ...
            @foreach($lambay as $lambay)
             ...
             <img src="{{asset('/image/'. $lambay->gambar_pulau)}}" alt="img">
               <img src="assetsIndex/img/rangyai1.jpg" alt="img">
               <img src="assetsIndex/img/rangyai2.jpg" alt="img">
             </div>
             <div class="aa-properties-info">
               <h2>{{$lambay->nama_pulau}}</h2>
               <span class="aa-price">$ {{ number_format($lambay->harga, 2) }}</span>
               </p>{{$lambay->deskripsi}}</p>
                 ...
                 <div class="row">
                   ...
                   @foreach($little as $little)
                     <article class="aa-properties-item">
                        <a class="aa-properties-item-img" href="little">
                        ...
                        <div class="aa-properties-item-content">
                          ...
                          <div class="aa-properties-about">
                            <h3><a href="rangyai">{{$little->nama_pulau}}</a></h3>
          ...
          <aside class="aa-properties-sidebar">
            ...
            <div class="aa-properties-single-sidebar">
              ...
              <form action="">
                ...
                <b>Status &nbsp;&nbsp;&nbsp;: {{$lambay->status}}</b>
                </div>
                <div class="aa-single-advance-search">
                <b>Negara &nbsp;: {{$lambay->nama_negara}}</b>
                </div>
                <div class="aa-single-advance-search">
                <b>Lokasi &nbsp;&nbsp;: {{$lambay->lokasi}}</b>
                </div>
                <div class="aa-single-advance-search">
                <b>Luas &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{$lambay->luas}} Acres<b>
                </div>
                <div class="aa-single-advance-search">
              ...
              <div class="aa-contact-form">
                <form class="contactform" action="storeInquire" method="post" enctype="multipart/form-data">
                  ...
                  <p class="comment-form-author">
                    <input type="text" name="id_pulau" value="{{$lambay->id_pulau }}" size="30" required="required" style="display:none">
                  </p>
                  @endforeach  
                  @if(auth()->check())                
                  <p class="comment-form-author">
