          ...
          <div class="aa-properties-content">            
            ...
            @foreach($macan as $macan)
             ...
             <div class="aa-properties-info">
               <h2>{{$macan->nama_pulau}}</h2>
               <span class="aa-price">$ {{ number_format($macan->harga, 2) }}</span>
               </p>{{$macan->deskripsi}}</p>
               ...
               <div class="aa-nearby-properties-area">
                 <div class="row">
                   ...
                   @foreach($cave as $cave)
                     <article class="aa-properties-item">
                        <a class="aa-properties-item-img" href="cave">
                        ...
                        <div class="aa-properties-item-content">
                          ...
                          <div class="aa-properties-detial">
                            ...
                            <a class="aa-secondary-btn" href="cave">View Details</a>
                          </div>
                        </div>
                        @endforeach
                      </article>
