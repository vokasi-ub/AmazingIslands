          ...
          <div class="aa-properties-content">            
            ...
            @foreach($es as $es)
             ...
             <div class="aa-properties-info">
               <h2>{{$es->nama_pulau}}</h2>
               <span class="aa-price">$ {{ number_format($es->harga, 2) }}</span>
               </p>{{$es->deskripsi}}</p>
          ...
          <aside class="aa-properties-sidebar">
            ...
            <div class="aa-properties-single-sidebar">
              ...
              <form action="">
                ...
                <b>Status &nbsp;&nbsp;&nbsp;: {{$es->status}}</b>
                </div>
                <div class="aa-single-advance-search">
                <b>Negara &nbsp;: {{$es->nama_negara}}</b>
                </div>
                <div class="aa-single-advance-search">
                <b>Lokasi &nbsp;&nbsp;: {{$es->lokasi}}</b>
                </div>
                <div class="aa-single-advance-search">
                <b>Luas &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{$es->luas}} Acres<b>
                </div>
                <div class="aa-single-advance-search">
              ...
              <div class="aa-contact-form">
                <form class="contactform" action="storeInquire" method="post" enctype="multipart/form-data">
                  ...
                  <p class="comment-form-author">
                    <input type="text" name="id_pulau" value="{{$es->id_pulau }}" size="30" required="required" style="display:none">
                  </p>
                  @endforeach  
                  @if(auth()->check())                
                  <p class="comment-form-author">
