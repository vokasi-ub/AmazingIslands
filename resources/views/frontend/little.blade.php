          ...
          <aside class="aa-properties-sidebar">
            ...
            <div class="aa-properties-single-sidebar">
              ...
              <form action="">
                ...
                <b>Status &nbsp;&nbsp;&nbsp;: {{$little->status}}</b>
                </div>
                <div class="aa-single-advance-search">
                <b>Negara &nbsp;: {{$little->nama_negara}}</b>
                </div>
                <div class="aa-single-advance-search">
                <b>Lokasi &nbsp;&nbsp;: {{$little->lokasi}}</b>
                </div>
                <div class="aa-single-advance-search">
                <b>Luas &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{$little->luas}} Acres<b>
                </div>
                <div class="aa-single-advance-search">
              ...
              <div class="aa-contact-form">
                <form class="contactform" action="storeInquire" method="post" enctype="multipart/form-data">
                  ...
                  <p class="comment-form-author">
                    <input type="text" name="id_pulau" value="{{$little->id_pulau }}" size="30" required="required" style="display:none">
                  </p>
                  @endforeach  
                  @if(auth()->check())                
                  <p class="comment-form-author">
